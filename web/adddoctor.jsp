...
<body>
  ...
  <form action="StoreDoctor" method="POST" enctype="multipart/form-data">
	    <h1>Add Doctor</h1>
    ...
    <div class="contentform">
    	<div id="sendmessage"> Doctor Added Successfully </div>
            ...
            <span class="icon-case"><i class="fa fa-user"></i></span>
				<input type="text" name="qualification" id="qualification" data-rule="required"/>
                <div class="validation"></div>
			</div>
			...
			<span class="icon-case"><i class="fa fa-envelope-o"></i></span>
                <input type="text" name="specialization" id="specialization" data-rule="required"/>
                <div class="validation"></div>
			</div>	
			...
			<span class="icon-case"><i class="fa fa-home"></i></span>
				<input type="text" name="experience" id="experience" data-rule="required"/>
                <div class="validation"></div>
			</div>

			<div class="form-group">
                            <p>Member Type<span>*</span></p>
                          
                            <select class="dpd" name="type" data-rule="required"/>
			...
			<span class="icon-case"><i class="fa fa-map-marker"></i></span>
				<input type="file" name="image" id="image" data-rule="required"/>
                <div class="validation"></div>
			</div>	
			...
			<span class="icon-case"><i class="fa fa-location-arrow"></i></span>
				<input type="password" name="password" id="password" data-rule="required" />
                <div class="validation"></div>
			</div>
