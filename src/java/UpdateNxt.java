 ...
 *
 */
public class UpdateNxt extends HttpServlet {
    ...
    ResultSet rs=ps.executeQuery();
        ...
        if(!b)
        {
        out.println("No Records Found For Record No.: "+id);
            RequestDispatcher rd=request.getRequestDispatcher("updatenext.jsp");
            rd.include(request, response);
        }
        
        String qr="update record set next=? where r_no=?";
        ...
        else
        {
            ...
            out.println("Next Visit Date Is: '"+nvd+"'<br>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateNxt.class.getName()).log(Level.SEVERE, null, ex);
