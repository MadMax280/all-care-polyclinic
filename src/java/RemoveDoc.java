   ...
   String qr="Select d_name from doctor where d_id=?";
    ...
    ResultSet rs=ps.executeQuery();
        ...
        if(!b)
        {
            ...
            RequestDispatcher rd=request.getRequestDispatcher("removedoctor.jsp");
            rd.include(request, response);
            
        }
       String s=rs.getString(1);
       
       String qr1="delete from doctor where d_id=?";
         PreparedStatement ps1=con.prepareStatement(qr1);
        ps1.setString(1, id);
        
        ps1.executeUpdate();
        out.println("<h1>Doctor " +s+ " has been Removed.</h1>");
        
        
        out.println("<a href='removedoctor.jsp'>Remove-More</a><br>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RemoveDoc.class.getName()).log(Level.SEVERE, null, ex);
