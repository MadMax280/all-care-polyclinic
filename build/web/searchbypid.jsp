...
<html><link href="pictures/logo.png" rel="icon" type="image" />
    <head>
        ...
        <title>Search By Record No.</title>
    </head>
...
<body>
   ...
   <div class="info"><p> Medical Dental & Orthodontic Centre </p></a></div>
  
  <form action="searchpid.jsp" method="POST">
    	...
    	<div id="sendmessage"> Doctor Added Successfully </div>
			      ...
			      <div class="form-group">
			        <p>Enter Patient ID<span>*</span></p>
...
<button type="submit" class="bouton-contact">Search</button>
