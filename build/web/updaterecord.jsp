...
<body>
   ...
   <div class="info"><a href="https://www.grandvincent-marion.fr" target="_blank"><p> Medical Dental & Orthodontic Centre </p></a></div>
  
  <form action="UpdateRec" method="POST">
	    <h1>Update Record</h1>
             <div class="contentform">
    	<div id="sendmessage"> Record Updated Successfully </div>


    	
			      <div class="form-group">
			        <p>Record NO.<span>*</span></p>
        ...
        <div class="form-group">
                            ...
                            <select class="dpd" name="t1"  required="required"/>
...
<ul>  <li><a href="updatenext.jsp"><input class="bt" type="button" value="To Update Next Visit Date Click Here" /></a></li> <ul> 
</div> 	
</form>	
